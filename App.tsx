...
const PRICING_PLANS = [
  {
    name: "LITE ESSENTIAL",
    price: "1.1 JT",
    description: "Selesai dalam 2-3 hari. Start prestisius untuk branding & profil UMKM.",
    features: [
      "Signature 1 Page Design",
      "Domain .online / .site (1 Tahun)",
      "High Speed Startup Hosting",
  ...
  },
  {
    name: "BUSINESS PRO",
    price: "2.8 JT",
    description: "Selesai dalam 4-6 hari. Arsitektur digital lengkap untuk bisnis profesional.",
    features: [
      "Up to 5 Pages Custom",
      "Domain .com (1 Tahun)",
      "Premium Business Hosting",
      "Professional Email (3 Akun)",
  ...
  },
  {
    name: "E-COMMERCE MAX",
    price: "4.9 JT",
    description: "Selesai dalam 7-14 hari. Toko online otomatis dengan fitur penjualan lengkap.",
    features: [
      "Complete Catalog System",
      "Payment Gateway Ready",
      "Automatic Shipping Rate",
      "Inventory Management",
      "WhatsApp Order System",
      "Customer Database CMS",
  ...
  },
  {
    name: "PREMIUM SYSTEM",
    price: "7.5 JT",
    description: "Selesai 14-21 hari. Solusi sistem fungsional tinggi untuk operasional bisnis.",
    features: [
  ...
  },
  {
    name: "ELITE PLATFORM",
    price: "10.3 JT",
    description: "Mahakarya digital eksklusif dengan riset UX mendalam dan skala enterprise.",
    features: [
      "Full UX Research Cycle",
      "Enterprise Cloud Server",
      "Custom AI Chatbot Sync",
      "3D Interactive Elements",
      "Speed Audit Perfection",
      "Unlimited Revisions",
...
const SERVICES = [
  {
    ...
    desc: "Visual yang memikat dengan standar estetika tinggi untuk brand eksklusif. Setiap pixel dipertimbangkan dengan matang untuk menciptakan impresi pertama yang abadi.",
    icon: <Palette className="w-8 h-8 text-gold" />,
    color: "bg-blue-50/50",
    tags: ["UI/UX", "Branding", "Visual"]
  },
  {
    title: "Elite Engineering",
    desc: "Arsitektur website yang kokoh, cepat, dan modern menggunakan teknologi terbaru. Kami memastikan performa tanpa kompromi bahkan pada beban trafik tinggi.",
    icon: <Code2 className="w-8 h-8 text-gold" />,
    color: "bg-purple-50/50",
    tags: ["React", "Typescript", "Speed"]
  },
  {
    title: "Digital Growth",
    desc: "Strategi SEO dan branding yang memastikan bisnis Anda tidak hanya terlihat bagus, tapi juga dominan di pasar digital dan mudah ditemukan oleh target audiens.",
    icon: <Zap className="w-8 h-8 text-gold" />,
    color: "bg-orange-50/50",
    tags: ["SEO", "AdWords", "Conversion"]
  },
  {
    title: "Eco System",
    desc: "Integrasi sistem yang memudahkan operasional bisnis Anda, dari pembayaran otomatis hingga manajemen stok yang pintar dan terintegrasi penuh.",
    icon: <Cpu className="w-8 h-8 text-gold" />,
    color: "bg-green-50/50",
    tags: ["Payment", "ERP", "Automation"]
  }
];
...
export default function App() {
  ...
  const handleContactSubmit = () => {
    if (!formData.name || !formData.plan) {
      alert("Mohon isi nama dan pilih paket.");
      return;
    }
    
    const message = `Halo Djaya Studio,%0A%0ASaya *${formData.name}* ingin berkonsultasi mengenai paket *${formData.plan}*.%0A%0A*Pesan:*%0A${formData.message || 'Tidak ada pesan tambahan.'}`;
    const whatsappUrl = `https://wa.me/6285872118540?text=${message}`;
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 selection:bg-gold selection:text-white overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[95vh] flex flex-col items-center justify-center text-center px-6 pt-20 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gold/10 rounded-full blur-[120px] -z-10 animate-pulse" />
        ...
        <div className="max-w-6xl relative">
          ...
          >
            <div className="inline-flex items-center gap-4 px-5 py-2.5 rounded-full bg-neutral-50/80 border border-neutral-100 mb-10 shadow-sm backdrop-blur-sm">
              <span className="text-neutral-500 uppercase tracking-[0.4em] text-[8px] font-black opacity-80 decoration-gold decoration-2 underline-offset-4 underline">Elite Standard Studio</span>
            </div>
            
            <h1 className="font-display text-7xl md:text-[11.5rem] font-bold leading-[0.82] mb-12 tracking-tighter luxury-gradient-text drop-shadow-sm select-none">
              Beyond <br />
              Excellence
            </h1>
            <p className="max-w-xl mx-auto text-neutral-500 text-lg md:text-xl mb-16 leading-relaxed font-light tracking-tight px-6 border-l-2 border-gold/40">
              Mendefinisikan ulang batas digital melalui perpaduan seni desain prestisius dan rekayasa teknologi tanpa kompromi.
            </p>
            <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#portfolio" 
                className="bg-neutral-900 text-white px-16 py-7 rounded-full font-black text-[10px] uppercase tracking-widest hover:bg-gold transition-all duration-500 shadow-[0_25px_60px_rgba(0,0,0,0.25)] flex items-center gap-4 active:shadow-inner"
              >
                Eksplor Galeri <ChevronRight size={18} />
              </motion.a>
              <a href="#about" className="group px-14 py-6 rounded-full font-black text-[10px] uppercase tracking-widest transition-all flex items-center gap-2 text-neutral-400 hover:text-neutral-900">
                <span className="relative">
                  Filosofi Kami
                  <span className="absolute bottom-0 left-0 w-0 h-[1.5px] bg-gold group-hover:w-full transition-all duration-300"></span>
                </span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-24 gap-8">
            <div className="max-w-2xl">
              ...
              <h3 className="font-display text-5xl md:text-7xl font-bold tracking-tighter">Layanan Strategis & <br /> <span className="text-neutral-400">Teknologi Mutakhir</span></h3>
            </div>
            <p className="text-neutral-500 max-w-sm text-sm font-light leading-relaxed">
              Kami menggabungkan seni desain dengan kekuatan kode untuk menciptakan pengalaman digital yang tak terlupakan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {SERVICES.map((s, i) => (
              <motion.div 
                ...
                whileHover={{ y: -10 }}
                className={`p-10 ${s.color} border border-neutral-100 rounded-[3rem] hover:border-gold transition-all duration-500 pricing-card-shadow flex flex-col items-start group`}
              >
                <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center mb-8 shadow-sm border border-neutral-50 group-hover:rotate-12 transition-transform">
                  {s.icon}
                </div>
                <h4 className="text-xl font-bold mb-4 font-display tracking-wide">{s.title}</h4>
                <p className="text-neutral-500 leading-relaxed text-xs font-light mb-8">
                  {s.desc}
                </p>
                <div className="mt-auto flex flex-wrap gap-2">
                   {s.tags?.map((t, idx) => (
                     <span key={idx} className="text-[7px] uppercase font-black tracking-widest px-2 py-1 bg-white rounded-md border border-neutral-50 opacity-60 group-hover:opacity-100 transition-opacity">{t}</span>
                   ))}
                </div>
              </motion.div>
            ))}
      ...
      {/* Stats Section */}
      <section className="py-24 px-6 md:px-16 bg-white border-y border-neutral-100">
        <div className="max-w-7xl mx-auto">
           <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
              {[
                { n: "Elite", l: "Elite Design" },
                { n: "99.99%", l: "System Reliability" },
                { n: "Elite", l: "Service Standard" },
                { n: "Global", l: "Delivery Reach" }
              ].map((stat, i) => (
                <div key={i}>
                   <p className="text-6xl font-display font-bold text-neutral-900 mb-2">{stat.n}</p>
                   <p className="text-[9px] uppercase font-black tracking-widest text-gold">{stat.l}</p>
                </div>
              ))}
           </div>
        </div>
      ...
      <section className="py-20 bg-neutral-50/50 border-y border-neutral-100">
        <div className="max-w-7xl mx-auto px-6">
           <div className="flex flex-wrap justify-center items-center gap-16 md:gap-24 opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
              {[
                { n: "React", i: <Code2 size={24} /> },
                { n: "Tailwind", i: <Layout size={24} /> },
                { n: "Next.js", i: <Rocket size={24} /> },
                { n: "Cloudflare", i: <Shield size={24} /> },
                { n: "Vercel", i: <Globe size={24} /> },
                { n: "Firebase", i: <Cpu size={24} /> }
              ].map((tech, i) => (
                <div key={i} className="flex items-center gap-3 font-black text-[10px] uppercase tracking-[0.3em]">
                   {tech.i}
                   <span>{tech.n}</span>
                </div>
              ))}
      ...
      {/* Portfolio Gallery */}
      <section id="portfolio" className="py-32 px-6 md:px-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-gold uppercase tracking-[0.5em] text-[10px] font-black mb-6">Our Portfolio</h2>
              <h3 className="font-display text-5xl md:text-7xl font-bold tracking-tighter leading-tight">Kurasi Mahakarya <br /> <span className="text-neutral-300">Pilihan Kami</span></h3>
            </div>
            <p className="text-neutral-500 max-w-xs text-sm font-light leading-relaxed">
              Tiap proyek adalah tantangan unik untuk menciptakan standar baru dalam estetika digital.
            </p>
          </div>
          
          <div className="text-center py-52 border-[1px] border-neutral-100 rounded-[5rem] bg-neutral-50 pricing-card-shadow relative group overflow-hidden">
            <div className="absolute top-10 left-10 w-32 h-32 bg-gold/5 rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-10 right-10 w-40 h-40 bg-neutral-500/5 rounded-full blur-3xl" />
            ...
            >
              <h3 className="font-display text-7xl md:text-[10rem] font-black tracking-tighter luxury-gradient-text mb-8 uppercase leading-none select-none">
                COMING <br /> SOON
              </h3>
              <div className="flex items-center justify-center gap-4 mb-10">
                <div className="h-[1px] w-12 bg-neutral-200" />
                <p className="text-gold max-w-xl mx-auto text-sm font-black tracking-[0.5em] uppercase">
                   Mahakarya Sedang Dimatangkan
                </p>
                <div className="h-[1px] w-12 bg-neutral-200" />
              </div>
              <p className="text-neutral-400 max-w-md mx-auto text-sm font-light leading-relaxed px-8">
                 Kami sedang menyusun showcase terbaik yang akan mendefinisikan ulang standar visual dan teknis di industri ini.
              </p>
            </motion.div>
          </div>

          <div className="mt-20 text-center py-24 border border-dashed border-neutral-200 rounded-[4rem] group hover:border-gold transition-colors">
             <h4 className="text-neutral-300 font-display text-5xl md:text-7xl font-bold tracking-tighter group-hover:text-gold/40 transition-colors uppercase">Maksimal Tanpa Batas</h4>
             <p className="mt-4 text-xs font-black uppercase tracking-[0.5em] text-neutral-400">Jadilah brand besar berikutnya yang kami kembangkan</p>
          </div>
        </div>
      </section>
      ...
      {/* Workflow Section */}
      <section id="workflow" className="py-32 px-6 md:px-16 bg-neutral-50/50 text-neutral-900 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-24 gap-8">
            <div className="max-w-2xl">
              <h2 className="text-gold uppercase tracking-[0.5em] text-[10px] font-black mb-6">Workflow</h2>
              <h3 className="font-display text-5xl md:text-7xl font-bold tracking-tighter">Siklus <span className="text-neutral-400">Penciptaan</span></h3>
            </div>
            <p className="text-neutral-500 max-w-sm text-sm font-light leading-relaxed">
              Proses kami terstruktur untuk menjamin transparansi dan kualitas tinggi di setiap tahap pembangunan digital Anda.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { n: "01", t: "Discovery", d: "Kami mendalami visi Anda, target pasar, dan spesifikasi fungsional yang dibutuhkan." },
              { n: "02", t: "Blueprint", d: "Perancangan arsitektur data dan UI/UX berstandar estetika mewah dan eksklusif." },
              { n: "03", t: "Forging", d: "Pengembangan sistem dengan standar kode modern untuk performa dan keamanan puncak." },
              { n: "04", t: "Ascendance", d: "Peluncuran sistem ke publik dengan dukungan penuh dan optimasi berkelanjutan." }
            ].map((step, i) => (
              <div key={i} className="p-10 bg-white border border-neutral-100 rounded-[3rem] pricing-card-shadow relative overflow-hidden group">
                <div className="text-8xl font-display font-black text-neutral-50 absolute -top-4 -right-4 group-hover:text-gold/5 transition-colors tracking-tighter">{step.n}</div>
                <div className="relative z-10">
                  <div className="w-12 h-12 bg-neutral-900 rounded-xl flex items-center justify-center text-white mb-8 group-hover:bg-gold transition-colors font-black text-xs">
                     {step.n}
                  </div>
                  <h4 className="text-2xl font-bold mb-4 tracking-tight group-hover:text-gold transition-colors">{step.t}</h4>
                  <p className="text-neutral-500 text-xs font-light leading-relaxed">{step.d}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="contact" className="py-40 px-6 md:px-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-center text-left">
               <div>
                  <h2 className="text-gold uppercase tracking-[0.4em] text-[10px] font-black mb-6 block">Ready to start?</h2>
                  <h3 className="font-display text-5xl md:text-7xl font-bold tracking-tight mb-10">Mari Bangun <br /> <span className="text-neutral-300 font-light italic">Masa Depan</span></h3>
                  <p className="text-neutral-500 text-lg font-light leading-relaxed mb-12">
                      Hubungi tim elit kami atau isi form untuk mendiskusikan bagaimana kami bisa mentransformasi bisnis Anda menjadi karya digital prestisius.
                  </p>
                  <div className="space-y-8">
                    <a href="https://wa.me/6285872118540" className="flex items-center gap-6 group">
                       <div className="w-14 h-14 bg-neutral-50 rounded-2xl flex items-center justify-center text-green-500 group-hover:bg-green-500 group-hover:text-white transition-all">
                          <MessageCircle size={24} />
                       </div>
                       <div>
                          <p className="text-[10px] font-black uppercase tracking-widest text-neutral-400">WhatsApp Admin</p>
                          <p className="text-xl font-bold tracking-tight">0858-7211-8540</p>
                       </div>
                    </a>
                    <a href="https://instagram.com/djaya.it" className="flex items-center gap-6 group">
                       <div className="w-14 h-14 bg-neutral-50 rounded-2xl flex items-center justify-center text-purple-500 group-hover:bg-purple-600 group-hover:text-white transition-all">
                          <Instagram size={24} />
                       </div>
                       <div>
                          <p className="text-[10px] font-black uppercase tracking-widest text-neutral-400">Instagram Insight</p>
                          <p className="text-xl font-bold tracking-tight">@djaya.it</p>
                       </div>
                    </a>
                  </div>
               </div>

               <div className="bg-neutral-50 p-12 rounded-[4rem] border border-neutral-100 shadow-2xl relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-8 opacity-5">
                    <PenTool size={200} />
                  </div>
                  <div className="relative z-10 space-y-8">
                     <div className="space-y-2">
                        <label className="text-[9px] uppercase font-black tracking-widest text-neutral-400">Nama Anda</label>
                        <input 
                          className="w-full bg-white border border-neutral-100 rounded-2xl p-5 text-sm focus:outline-none focus:border-gold transition-colors" 
                     ...
                     <div className="space-y-2">
                        <label className="text-[9px] uppercase font-black tracking-widest text-neutral-400">Paket Pilihan</label>
                        <select 
                          className="w-full bg-white border border-neutral-100 rounded-2xl p-5 text-sm focus:outline-none focus:border-gold transition-colors appearance-none"
                          value={formData.plan}
                          onChange={(e) => setFormData({...formData, plan: e.target.value})}
                        >
                           <option value="">Pilih Paket...</option>
                           {PRICING_PLANS.map((p, i) => <option key={i} value={p.name}>{p.name}</option>)}
                        </select>
                     </div>
                     <div className="space-y-2">
                        <label className="text-[9px] uppercase font-black tracking-widest text-neutral-400">Tinggalkan Pesan</label>
                        <textarea 
                          className="w-full bg-white border border-neutral-100 rounded-2xl p-5 text-sm focus:outline-none focus:border-gold transition-colors min-h-[150px]" 
                     ...
                     <button 
                       ...
                       className="w-full bg-neutral-900 text-white py-6 rounded-full font-black text-[10px] uppercase tracking-widest hover:bg-gold transition-all duration-500 shadow-xl"
                     >
                        Kirim Sekarang
                     </button>
                  </div>
      ...
      <motion.a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-10 right-10 z-[100] w-16 h-16 bg-green-500 text-white rounded-full flex items-center justify-center shadow-[0_15px_40px_rgba(34,197,94,0.4)] hover:shadow-green-500/60 transition-shadow group"
      >
        <MessageCircle size={32} />
        <span className="absolute right-20 bg-neutral-900 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest opacity-0 group-hover:opacity-100 pointer-events-none transition-all mr-2 whitespace-nowrap shadow-xl">
           Konsultasi Sekarang
        </span>
      </motion.a>
